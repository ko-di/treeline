/**
 * Page sections for treeline.
 *
 * Each section is a named export. Pages import only the sections they need.
 * Distribution across routes:
 *
 *   /                  — Hero, Refusals, Trail, Install, Tip, Footer
 *   /how-it-works      — HowItWorks, Studio, Artifacts, ForWhom, Footer
 *   /about             — About, Footer
 *   /docs              — own content + Footer
 *
  ...
  return (
    <section className="section">
      <div className="shell">
        ...
        <p className="t-small t-muted mt-12 max-w-[60ch]">
          Want the full picture before installing? Read{" "}
          <Link
            href="/how-it-works"
            className="underline decoration-1 underline-offset-4 hover:decoration-2"
          >
...
/* ─────────────────────────────────────────────────
   Refusals — the filter, friction-as-feature
   ───────────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────────
   Trail — the six camps + Mermaid diagram
   ───────────────────────────────────────────────── */
...
const steps: { n: string; title: string; body: string; cmd?: string }[] = [
  ...
  },
  {
    ...
    body: "Clone forest-kit as a template, run setup. You get the camps, the references, the skills, the empty compass.json. One folder per project.",
  },
  {
    n: "03",
    title: "Type /pack.",
...
const personas: { verb: string; persona: string }[] = [
  { verb: "/scout", persona: "The researcher with taste — warm, allergic to leading questions." },
  { verb: "/sketch", persona: "The senior design director — observant, decisive, systematic." },
  { verb: "/gather", persona: "The synthesis researcher — biased against confirmation." },
  { verb: "/rationale", persona: "The careful witness who records, doesn't gloss." },
  { verb: "/ship", persona: "The careful engineer who ships clean, not fast." },
  { verb: "/handoff", persona: "The careful packager who assumes the receiver never speaks to you again." },
];
...
const artifacts: { path: string; what: string }[] = [
  { path: "compass.json", what: "Vision, audience, product, feeling, stack, beneficiary. The project's North Star — single file, schema-versioned." },
  { path: "map.md", what: "Six camps with progress, decisions, current state. Mermaid diagram of the trail. The state-of-the-world." },
  { path: "camps/<n>-*/", what: "Working files per stage — research notes, drafts, sketches, the captured idea, the PRD." },
  { path: "design/decisions/", what: "One file per significant decision, with reasoning, alternatives considered, and reversibility." },
  { path: "research/raw/", what: "Raw interview notes and observations, before synthesis. The actual conversations, not summaries." },
  { path: "SUMMIT.md", what: "Compiled summary at trail completion, ending in a deliberately empty three-month reflection section." },
  { path: "the working repo", what: "If you walked Build and Ship, the actual product code. Yours, in your repo, deployed to your hosting." },
];
...
/* ─────────────────────────────────────────────────
   About — Studio K stance + the moat said honestly
   ───────────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────────
   Install — three terminal blocks, copyable
   ───────────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────────
   Tip — Revolut Pay link, no paywall
   ───────────────────────────────────────────────── */
